...
export interface UserDataMapPayload {
...
export interface _SERVICE {
  bulkInsertUsers: ActorMethod<[], Result>
  ...
  getListOfUsersWithData: ActorMethod<[], Array<UserDataMapPayload>>
  getUserAccountInfo: ActorMethod<[], UserAccountInfoPayload>
  getUserByPrincipal: ActorMethod<[string], [] | [UserPayload]>
  ...
  removeAnonymousPrincipalEntryFromUserCanisterMap: ActorMethod<[], string>
  signUp: ActorMethod<[string], string>
  updateCanistergeekInformation: ActorMethod<
    [UpdateInformationRequest],
    undefined
  >
  updateUserRecord: ActorMethod<[string, UpdateUserRequestPayload], string>
  updateUserSubAccountIndexes: ActorMethod<[], bigint>
  ...
  verifyPaymentTest: ActorMethod<[string], boolean>
}
