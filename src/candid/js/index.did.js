export const idlFactory = ({ IDL }) => {
  ...
  const RegistrationCheckSuccess = IDL.Record({
    'canister_id' : IDL.Principal,
    'subaccount_ledger_identifier' : IDL.Opt(IDL.Text),
    'message' : IDL.Text,
    'subaccount_id_hex' : IDL.Opt(IDL.Text),
  });
  const RegistrationCheckError = IDL.Record({
    'canister_id' : IDL.Opt(IDL.Principal),
    'subaccount_ledger_identifier' : IDL.Opt(IDL.Text),
    'message' : IDL.Text,
    'subaccount_id_hex' : IDL.Opt(IDL.Text),
  });
  const RegistrationCheckResult = IDL.Variant({
    'ok' : RegistrationCheckSuccess,
  ...
  return IDL.Service({
    ...
    'getListofTransactions' : IDL.Func(
        [],
        [IDL.Vec(TransactionResponsePayload)],
        ['query'],
      ),
    ...
    'getUserCanisterByUserPrincipal' : IDL.Func(
        [IDL.Text],
        [IDL.Text],
        ['query'],
      ),
