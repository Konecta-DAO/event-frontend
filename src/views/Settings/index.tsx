...
import AddPaymentMethod from 'components/Modals/AddPaymentMethod/index.tsx'
import AntSwitch from 'components/AntSwitch/index.tsx'
import { languages } from 'utils/values.tsx'
import { EditIcon, ProtectIcon, VisaCardIcon } from 'utils/svg-icons.tsx'
...
export default function Settings() {
  ...
  const handlePaymentMethodClose = useCallback(() => {
        ...
        <div className="flex justify-between py-[40px] border-b border-[#FFFFFF1A]">
          ...
          <div className="flex flex-col w-full max-md:w-fit">
            ...
            <div className="flex py-[32px] max-md:py-0">
              <Button
                text={`${isonTabletOrMobile ? 'Add Wallet' : 'Add payment method'
                  }`}
                icon={<AddOutlined />}
                onClick={() => setAddPaymentMethod(true)}
              />
